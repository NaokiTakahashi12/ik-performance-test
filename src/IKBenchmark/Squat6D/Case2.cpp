...
namespace IKBenchmark {
    namespace Squat6D {
        ...
        Case2<Scaler>::Case2() : SquatMotion<Scaler>::SquatMotion() {
        }
        ...
        template <typename Scaler>
        void Case2<Scaler>::set_benchmark_param(typename SquatMotion<Scaler>::BenchmarkConfig &config) {
            constexpr Scaler normalied_maximum_range = 1.02;
            constexpr Scaler normalied_minimum_range = 0.98;
            constexpr Scaler normalied_step_range = 0.001;
