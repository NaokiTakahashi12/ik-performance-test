...
namespace IKBenchmark {
    namespace Squat6D {
        ...
        Case3<Scaler>::Case3() : SquatMotion<Scaler>::SquatMotion() {
        }
        ...
        template <typename Scaler>
        void Case3<Scaler>::set_benchmark_param(typename SquatMotion<Scaler>::BenchmarkConfig &config) {
            constexpr Scaler normalied_maximum_range = 2.00;
            constexpr Scaler normalied_minimum_range = 0.75;
            constexpr Scaler normalied_step_range = 0.05;
